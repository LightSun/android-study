...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix='D:/ffmpeg/install' --enable-shared --disable-static --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-symver --enable-small --cross-prefix='D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/toolchains/arm-Linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-' --target-os=linux --arch=arm --enable-cross-compile --sysroot='D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/platforms/android-16/arch-arm/' --extra-cflags='-Os -fpic -marm' --extra-ldflags=
...
ARCH=arm
INTRINSICS=none
CC=D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/toolchains/arm-Linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
CXX=D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/toolchains/arm-Linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-g++
AS=D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/toolchains/arm-Linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
OBJCC=D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/toolchains/arm-Linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
LD=D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/toolchains/arm-Linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DEPCC=D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/toolchains/arm-Linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/toolchains/arm-Linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/toolchains/arm-Linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/toolchains/arm-Linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-ranlib -D
STRIP=D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/toolchains/arm-Linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/platforms/android-16/arch-arm/ -isysroot D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/platforms/android-16/arch-arm/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -Os -fpic -marm -march=armv5te -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
LD_PATH=-L
DLLTOOL=
WINDRES=D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/toolchains/arm-Linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-windres
DEPWINDRES=D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/toolchains/arm-Linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DOXYGEN=doxygen
LDFLAGS=   --sysroot=D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/platforms/android-16/arch-arm/ -isysroot D:/android/android-ndk-r12b-windows-x86_64/android-ndk-r12b/platforms/android-16/arch-arm/ -march=armv5te -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
