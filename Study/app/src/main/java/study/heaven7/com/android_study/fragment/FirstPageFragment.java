...
import study.heaven7.com.android_study.help.FragmentPagerAdapter2;
import study.heaven7.com.android_study.help.TrackTestUtil;
import study.heaven7.com.android_study.view.SlidingTabLayout;
...
public class FirstPageFragment extends BaseTrackTestFragment {
    ...
    private void onPreSelect(int position) {
      ...
      /*  if(lastIndex >= 0) {
            BaseTrackTestFragment fragment = (BaseTrackTestFragment) mAdapter.getItem(lastIndex);
            fragment.untrackThisFragment();
            TrackTestUtil.logIfNeed(TAG,"onPreSelect", "untrack: "+ fragment.getPageName());
        }*/
