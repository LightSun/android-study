...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public void setEnableIndicator(boolean enableIndicator){
        mTabStrip.setEnableIndicator(enableIndicator);
    }
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTabViewLayoutId != 0) {
                ...
                if(mInitTitleListener!=null){
                    mInitTitleListener.onInitTitle(i,tabTitleView);
                }
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            if(mLastSelectIndex != position)
                mLastSelectIndex = position;
        }
    ...
    void setOnTabListener(OnTabListener l){
    ...
    /**
     * this will be only used when call {@link #setCustomTabView(int, int)}
     */
    public interface OnInitTitleListener{
       void onInitTitle(int position, TextView title);
    }
    /** called when use */
    public interface OnPreSwitchListener{

        void onPreSwitch(int lastIndex);
    }
}
