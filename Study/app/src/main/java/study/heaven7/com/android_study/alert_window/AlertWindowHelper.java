package study.heaven7.com.android_study.alert_window;
...
import study.heaven7.com.android_study.util.ScreenUtils;
...
public class AlertWindowHelper {
    ...
    public AlertWindowHelper(Context context) {
        ...
        this.mStateBarHeight = ScreenUtils.getStatusHeight(context);
    }
    public View getView() {
         return mView;
    }
    ...
    private class DragTouchListener implements View.OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            mParams.x = (int) event.getRawX() - mView.getMeasuredWidth() / 2;
            mParams.y = (int) event.getRawY() - mView.getMeasuredHeight() / 2 - mStateBarHeight;
