...
public class LayoutAnimatorFragment extends Fragment implements View.OnClickListener{
	...
	public void initViews(View rootView){
		...
		rootView.findViewById(R.id.bt_add_invisible_button).setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
			...
			case  R.id.bt_add_invisible_button:
				addButton(false);
				break;
	 ...
	 * 增加Button
	 */
	public void addButton(boolean visible){
		...
		mButton.setVisibility( visible ? View.VISIBLE : View.INVISIBLE);
