    ...
    private void startZoomInByScaleDelta(final float scaleDelta, long duration){
        ...
        va.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                float mImageViewW = (1 + value) * AutoZoomInImageView.this.mImageViewW;
                float mImageViewH = (1 + value) * AutoZoomInImageView.this.mImageViewH;
                updateMatrixValuesSpan(mValues, mDrawableW, mDrawableH, mImageViewW, mImageViewH,
                        oriScaleX, oriScaleY, value);
                mMatrix.setValues(mValues);
                ViewGroup.LayoutParams lp = getLayoutParams();
                lp.width = (int) mImageViewW;
                lp.height = (int) mImageViewH;
                setLayoutParams(lp);
                setImageMatrix(mMatrix);
            }
        });
