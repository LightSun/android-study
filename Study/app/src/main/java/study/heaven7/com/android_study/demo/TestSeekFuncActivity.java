...
/**
 * Created by heaven7 on 2017/6/14 0014.
 */

public class TestSeekFuncActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ac_seek_func);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                ObjectAnimator nopeAnimator = nope(nope);
